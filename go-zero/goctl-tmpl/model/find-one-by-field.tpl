func (m *default{{.upperStartCamelObject}}Model) Find{{.upperStartCamelObject}}By{{.upperField}}(ctx context.Context, {{.in}}, session ...sqlx.Session) (*{{.upperStartCamelObject}}, error) {
	...
	err := oneSession.QueryRowCtx(ctx, &resp, query, {{.lowerStartCamelField}})
	switch err {
	case nil:
		return &resp, nil
